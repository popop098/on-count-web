...
export default async function handler(req, res) {
    ...
    try {
        ...
        console.error('Access token expired or invalid. Forcing logout.', error.response?.data || error.message);
        ...
        res.status(401).json({ message: 'Token expired, user has been logged out.' });
    }
}
