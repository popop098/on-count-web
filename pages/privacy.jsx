      ...
      <ContainerBox>
        <div className="w-full max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-lg text-gray-600 dark:text-gray-300 mx-auto">
            ...
            <h2>제 1조 (총칙)</h2>
            <p>
              온카운트(이하 '서비스')는 이용자의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
              서비스는 개인정보처리방침을 통하여 이용자가 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
            </p>
            ...
            <p>
              기타 개인정보 처리에 관한 자세한 사항은 관련 법령 및 서비스의 개인정보처리방침을 참조하시기 바랍니다.
            </p>
          </div>
        </div>
      </ContainerBox>
