import {
    ...
    ModalBody,
    ModalFooter,
    useDisclosure, Dropdown, DropdownTrigger, Avatar, DropdownMenu, DropdownItem, DropdownSection, NavbarMenuToggle,
...
export const NavBarComp = () => {
    const {isOpen: signinModalIsOpen, onOpen: signinModalOnOpen, onOpenChange: signinModalOnOpenChange} = useDisclosure();
        ...
        <>
            <Modal isOpen={signinModalIsOpen} onOpenChange={signinModalOnOpenChange}>
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1">들어가기</ModalHeader>
                            <ModalBody>
                                <Button fullWidth variant="shadow" isLoading={isSigninBtnLoading} onPress={handleSigninBtn}>
                                    <div className="flex gap-1 items-center justify-center">
                                        <Image src={ChzzkLogo} alt={'ChzzkLogo'} width={30} height={30} />
            ...
            <Navbar isBordered className="w-[80%] fixed mx-auto mt-5 rounded-3xl h-fit" >
                <NavbarContent>
                    <NavbarMenuToggle
                        ...
                        />
                    <NavbarBrand>
                        <Image src={OnCountLogo} alt={'OnCount Logo'} width={50} height={50} className="rounded-xl"/>
                    </NavbarBrand>
                </NavbarContent>
                <NavbarContent className="hidden sm:flex gap-4" justify="center">
                    ...
                    {
                        user && <NavbarItem isActive={pathname==="/me"}>
                            <Link
                        ...
                        user ? (
                            <>
                                <Dropdown placement="bottom-end">
                                    ...
                                    <DropdownMenu aria-label="Profile Menus" variant="flat" disabledKeys={["profile"]}>
                                        ...
                                        <DropdownSection title="위험 구역">
                                            <DropdownItem onPress={handleSignoutBtn} color="danger" className="text-danger" description="현재 로그인한 계정에서 로그아웃 합니다." key="signOut">
                                                로그아웃
                                            </DropdownItem>
                                        </DropdownSection>
                                    </DropdownMenu>
