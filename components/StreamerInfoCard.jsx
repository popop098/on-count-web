...
export const StreamerInfoCard = ({channelName, channelImageUrl, channelUrl, channelFollwerCount, channelVerificationMark}) => {
    return (
        <>
            <Card className="py-4">
                <CardBody className="overflow-visible py-2 space-y-2 flex items-center justify-center w-full">
                    ...
                    <Button fullWidth color="primary" variant="ghost" onPress={()=>router.push(channelUrl)}>
                        이동
                    </Button>
                </CardBody>
            </Card>
