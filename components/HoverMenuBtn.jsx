              ...
              <Dropdown placement="bottom-end">
                  <DropdownTrigger>
                      <Button isIconOnly color="primary" className="p-1" variant="shadow">
                          <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 20 20"><path fill="#fff" d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
                      </Button>
                  </DropdownTrigger>
                  <DropdownMenu aria-label="Settings Actions" variant="flat">
                      <DropdownItem key="DarkMode" onPress={()=>setTheme(theme==="light" ? "dark" : "light")} startContent={theme==="light" ? <Dark /> : <Light/>}>
                          {
                              theme==="light" ? "어둡게" : "밝게"
                          }
                      </DropdownItem>
